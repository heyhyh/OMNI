...
static void A_P(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_P.IN.P = PARAM;}
static void A_I(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_P.IN.I = PARAM;}
static void A_D(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_P.IN.D = PARAM;}
static void A_ILIT(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_P.IN.I_LIT = PARAM;}
static void A_ALIT(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_P.IN.ALL_LIT = PARAM;}

static void S_P(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_S.IN.P = PARAM;}
static void S_I(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_S.IN.I = PARAM;}
static void S_D(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_S.IN.D = PARAM;}
static void S_ILIT(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_S.IN.I_LIT = PARAM;}
static void S_ALIT(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_S.IN.ALL_LIT = PARAM;}

static void C_P(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_C.IN.P = PARAM;}
static void C_I(YUN_TYPEDEF_MOTOR *MOTOR, float PARAM) {MOTOR->PID_C.IN.I = PARAM;}
...
void YUN_F_VOFA_ASSIGN(YUN_TYPEDEF_RECV_UNION *RECV)
{
    ...
    if (IT_TAIL != WRITE_MAP.end())
    {
        switch (MOTOR_TYPE)
        {
            case YUN_D_VOFA_C1: IT_TAIL->second(&YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_1], RECV->DATA.PARAM);
                break;
            case YUN_D_VOFA_C2: IT_TAIL->second(&YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_2], RECV->DATA.PARAM);
                break;
            case YUN_D_VOFA_C3: IT_TAIL->second(&YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_3], RECV->DATA.PARAM);
                break;
            case YUN_D_VOFA_C4: IT_TAIL->second(&YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_4], RECV->DATA.PARAM);
                break;
            case YUN_D_VOFA_GY: IT_TAIL->second(&YUN_V_MOTOR_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW], RECV->DATA.PARAM);
                break;
...
{
    switch (MOTOR_TYPE) {
        case YUN_D_VOFA_C1: YUN_F_VOFA_DEBUG_CAL(&YUN_V_DEBUG[YUN_D_VOFA_C1], &YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_1]);
            break;
        case YUN_D_VOFA_C2: YUN_F_VOFA_DEBUG_CAL(&YUN_V_DEBUG[YUN_D_VOFA_C2], &YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_2]);
            break;
        case YUN_D_VOFA_C3: YUN_F_VOFA_DEBUG_CAL(&YUN_V_DEBUG[YUN_D_VOFA_C3], &YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_3]);
            break;
        case YUN_D_VOFA_C4: YUN_F_VOFA_DEBUG_CAL(&YUN_V_DEBUG[YUN_D_VOFA_C4], &YUN_V_MOTOR_CHASSIS[YUN_D_MOTOR_CHASSIS_4]);
            break;
