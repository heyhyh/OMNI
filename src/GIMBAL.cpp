...
YUN_TYPEDEF_MOTOR_ YUN_V_GIMBAL[2]{ };
...
//    if( YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].DATA.AIM > 5200)
//    {
//        printf("yaw aim limit ok");
//        YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].DATA.AIM = 5200;
//    }
...
{   YUN_F_MOTOR_CLEAR(&YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW],YUN_D_MOTOR_GIMBAL_YAW);
    ...
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.IN.P = 5;
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.IN.I = 0.0001;
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_PIT].PID_P.IN.I = 0.0001;
    ...
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_PIT].PID_P.IN.ALL_LIT = 8000;
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_PIT].PID_P.IN.I_LIT = 8000;
    YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.IN.I_LIT = 8000;
    while(1){
...
//        printf("YAW:%d\nPITCH:%d\n",YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.out.ALL_OUT,YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_PIT].PID_P.out.ALL_OUT);
//        YUN_F_CAN_SEND(2, 0X2FF,YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.out.ALL_OUT,0,YUN_V_GIMBAL[YUN_D_MOTOR_GIMBAL_YAW].PID_P.out.ALL_OUT,0);
        usleep(1);
    }
