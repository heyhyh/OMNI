...
//电流环
MOTOR->PID_P.out.ERROR[YUN_D_NOW] = MOTOR->PID_P.out.ALL_OUT - (float )MOTOR->DATA.CURRENT;
//比例输出
MOTOR->PID_P.out.P_OUT = (MOTOR->PID_P.out.ERROR[YUN_D_NOW] * MOTOR->PID_P.out.ERROR[YUN_D_LAST]);
//积分输出
